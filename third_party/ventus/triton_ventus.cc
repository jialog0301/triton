...
void init_triton_ventus(py::module_ &m) {
  ...
  auto toolchain =
      py::class_<ToolchainIdentity>(m, "ArtifactToolchainIdentity")
          .def(py::init<>())
  ...
  auto grid =
      py::class_<GridMetadata>(m, "ArtifactGridMetadata")
          .def(py::init<>())
  ...
  auto constraints =
      py::class_<KernelConstraints>(m, "ArtifactKernelConstraints")
          .def(py::init<>())
  ...
  auto resources =
      py::class_<ResourceMetadata>(m, "ArtifactResourceMetadata")
          .def(py::init<>())
  ...
  auto raw = py::class_<RawResourceRecord>(m, "ArtifactRawResourceRecord")
                 ...
                 .def_rw("target_endian_decoded",
                         &RawResourceRecord::targetEndianDecoded);
  ...
  auto capability =
      py::class_<CapabilityRecord>(m, "ArtifactCapabilityRecord")
          .def(py::init<>())
          ...
          .def_rw("completion_observable",
                  &CapabilityRecord::completionObservable)
          .def_rw("cache_flush_observable",
                  &CapabilityRecord::cacheFlushObservable);
  ...
  py::class_<VentusKernelMetadata>(m, "VentusKernelMetadata")
      ...
      .def_static("validate", [](const VentusKernelMetadata &metadata,
